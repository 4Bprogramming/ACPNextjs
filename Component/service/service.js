...
export const services =[
    {
      src: <Image  src={mano} width={300} height={200}  alt="Coach Empresarial" />,
    ...
    {
      src:<Image  src={laptop} width={300} height={200} alt="Imagen Corporativa" />,
    ...
    {
      src: <Image  src={inge} width={300} height={200} alt="Gestión Interna" />,
